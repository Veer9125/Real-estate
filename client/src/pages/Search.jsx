        ...
        <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
            <form className="flex flex-col gap-8">
                <div className="flex items-center gap-2">
                    ...
                    <input type="text" id='searchTerm' placeholder='Search...' className='border rounded-lg p-3 focus:outline-none w-full' />
                </div>
                ...
                <button className="bg-slate-700 text-white p-3 rounded-lg uppercase hover:opacity-95 disabled:opacity-80 duration-500">Search</button>
            </form>
        </div>
        <div className="">
